...
define("META_DESC", 'e-Application Platform');
...
# ======================================================================
# SYSTEM ACCESS NAME
define("SYSTEM_ACCESS_NAME", getenv('SYSTEM_ACCESS_NAME')) ?: 'E-APP';

# ======================================================================
# SYSTEM HUB ROUTING DEFINITIONS
$local_folder = getenv('LOCAL_SUBFOLDER')    ?: 'dev_e_app';
...
define("FAVICON",       BASE_UPLOAD_LOGO_PATH . 'ccc-banner.webp?v=' . FILE_VERSION);
define("CCC_FAVICON",   BASE_UPLOAD_LOGO_PATH . 'ccc-favicon.ico?v=' . FILE_VERSION);

# White Variant Logos
define("WHITE_LOGO",         BASE_UPLOAD_LOGO_PATH . 'ccc-banner.webp?v=' . FILE_VERSION);
define("WHITE_DISPLAY_LOGO", BASE_UPLOAD_LOGO_PATH . 'ccc-banner.webp?v=' . FILE_VERSION);
...
$default_session = !empty($env_session_name) ? $env_session_name : ((defined('SYSTEM_FLAG') && SYSTEM_FLAG === 'DEV') ? 'e_e_dev_app_session' : 'eapp_session');
